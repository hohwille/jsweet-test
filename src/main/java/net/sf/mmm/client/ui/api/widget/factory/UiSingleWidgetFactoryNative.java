...
/**
 * This is the interface for a factory of a single {@link net.sf.mmm.client.ui.api.widget.UiWidget} of a particular
 * {@link #getWidgetInterface() type}.
 *
 * @see net.sf.mmm.client.ui.api.UiContext
 * @param <WIDGET> the generic type of the {@link #getWidgetInterface() widget} to {@link #create(UiContext) create}.
 *
